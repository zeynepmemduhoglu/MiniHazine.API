...
namespace MiniHazine.API.Migrations
{
    ...
    [Migration("20260831082242_AddUserPreferencesAndColumns")]
    partial class AddUserPreferencesAndColumns
    {
            ...
            modelBuilder.Entity("MiniHazine.API.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AutoRefresh = false,
                            CreatedAt = new DateTime(2026, 8, 31, 8, 22, 41, 964, DateTimeKind.Utc).AddTicks(7848),
                            DefaultCurrency = "TRY",
                            IsActive = true,
