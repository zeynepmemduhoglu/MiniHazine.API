  ...
  return (
    <div className={styles.dashboardContainer}>
      ...
      <div className={styles.metricsGrid}>
        ...
        <div className={styles.metricCard}>
          <div className={styles.cardInfo}>
            <span className={styles.cardTitle}>Pasif Hesaplar</span>
            <h3 className={styles.cardValue}>{loading ? '...' : passiveAccountsCount}</h3>
            <span className={styles.cardTrendWarning}>Askıdaki / Kapalı hesaplar</span>
          </div>
          <div className={`${styles.cardIcon} ${styles.orangeIcon}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="22" height="22"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>
          </div>
        </div>
